class WorldMapFactory {
	...
	createVersionOne() {
		...
		const bottomObstacle = new RectangeObstacle(this.width*0.45, this.height*0.5, this.width*0.1, this.height*0.3);
		const food = new Food(this.width*0.65, this.height*0.75, this.height/50);
